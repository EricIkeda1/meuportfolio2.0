...
const App: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      tags: ["Python", "Criptografia", "Segurança"],
      githubUrl: "https://github.com/EricIkeda1/Diffie-Hellman-ChatTCP.git",
      icon: "fas fa-lock"
    },
    {
      id: 3,
      ...
      tags: ["Python", "AES", "Criptografia"],
      githubUrl: "https://github.com/EricIkeda1/AES.git",
    ...
    },
    {
      ...
      tags: ["Pesquisa", "Normas ABNT", "Acadêmico"],
      externalUrl: "https://drive.google.com/file/d/1khtYl3Diga8rj4k32tb-y4G8taZ01aLi/view?usp=drive_link",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/EricIkeda1/Projeto_Arquitetura_de_Software.git",
    ...
    },
    {
      ...
      githubUrl: "https://github.com/EricIkeda1/R3DrawChek_Jornada20241",
    ...
    },
    {
      ...
      year: "2023",
      description: "Este projeto foi desenvolvido em equipe para a Usipav e tem como objetivo criar um sistema de monitoramento de produção industrial. Através de uma integração de dados provenientes de sensores, o sistema apresenta informações em tempo real por meio de一個 dashboard interativo.",
      tags: ["JavaScript", "React.js", "Python", "Django"],
      externalUrl: "https://jornada-2023-2-full-stack.vercel.app/",
